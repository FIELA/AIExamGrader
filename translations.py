TRANSLATIONS = {
    "CN": {
        ...
        "log_no_csv": "⚠️ 未找到成绩汇总表",
        "log_generating_csv": "🔄 正在生成成绩汇总表...",
        "log_found_csv": "✅ 已找到成绩汇总表",
        ...
        "log_no_answer_key": "❌ 未检测到标准答案配置，开始生成...",
        "log_request_sent_rocket": "🚀 请求已发出...",
        "log_waiting_confirmation": "⏳ 等待确认...",
        "log_answer_key_confirmed_generated": "✅ 已确认，已生成 answer_key.json",
        "log_detecting_layout": "🔍 正在检测答题卡布局配置...",
        "log_layout_detected": "✅ 已找到答题卡布局配置。",
        "log_no_layout_generating": "❌ 未检测到答题卡布局配置，开始生成...",
        "log_layout_req_sent": "📤 布局分析请求 {index} 已发出",
        "log_layout_req_received": "📥 布局分析请求 {index} 已收到回复",
        "log_layout_req_all_received": "✅ 已收到全部布局分析请求 ({count}/3)",
        ...
        "log_processing_file_index": "📝 [{current}/{total}] {filename}",
        "log_renamed_file": "🔄 重命名: {old} -> {new}",
        "log_filename_fallback": "⚠️ 文件名回退: {old} -> {new} (缺失考场/座位号)",
        "log_batch_regrading": "🔄 开始批量重新评分...",
        "log_found_student_records": "📊 找到 {count} 条学生记录。",
        ...
        # Directory Names
        "dir_grading_data": "阅卷数据",
        "dir_original_files": "原始文件",
        "dir_reports": "阅卷报告",
        "dir_success": "成功归档",
        "dir_failed": "失败归档"
    },
    "EN": {
        ...
        "log_no_csv": "⚠️ Grade Summary CSV not found",
        "log_generating_csv": "🔄 Generating Grade Summary CSV...",
        "log_found_csv": "✅ Grade Summary CSV found",
        ...
        "log_no_answer_key": "❌ No answer key configuration detected, generating...",
        "log_request_sent_rocket": "🚀 Request sent...",
        "log_waiting_confirmation": "⏳ Waiting for confirmation...",
        "log_answer_key_confirmed_generated": "✅ Confirmed, answer_key.json generated",
        "log_detecting_layout": "🔍 Detecting answer sheet layout configuration...",
        "log_layout_detected": "✅ Answer sheet layout configuration found.",
        "log_no_layout_generating": "❌ No layout configuration detected, generating...",
        "log_layout_req_sent": "📤 Layout analysis request {index} sent",
        "log_layout_req_received": "📥 Layout analysis request {index} received",
        "log_layout_req_all_received": "✅ Received all layout analysis requests ({count}/3)",
        ...
        "log_processing_file_index": "📝 [{current}/{total}] {filename}",
        "log_renamed_file": "🔄 Renamed: {old} -> {new}",
        "log_filename_fallback": "⚠️ Filename Fallback: {old} -> {new} (Room/Seat missing)",
        "log_batch_regrading": "🔄 Starting batch re-grading for all students...",
        "log_found_student_records": "📊 Found {count} student records to process.",
